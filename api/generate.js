        ...
        body: JSON.stringify({
          ...
          messages: [{
            ...
            content: [
              ...
              {
                type: 'text',
                text: `You are an expert at reading handwritten aviation maintenance logbook entries written by A&P mechanics and IA inspectors.

Carefully examine this image and transcribe ALL handwritten text. Aviation maintenance notes commonly include:
- Aircraft tail numbers (e.g. N12345, C-FABC)
- Part numbers (e.g. P/N 123456, S/N 789ABC)
- Time references in military time (e.g. 1330L, 0800Z)
- Aviation abbreviations (A&P, IA, RTS, AOG, MEL, AD, SB, AMM, TTSN, TBO, P/N, S/N, LRU, NDT)
- Work descriptions using maintenance terminology
- Certification statements and signatures
- Date entries in various formats

Instructions:
- Transcribe every word, number, and symbol you can see
- Preserve the original structure and line breaks
- For unclear words, use your best judgment based on aviation maintenance context and surrounding text
- Do not skip or summarize any content
- If a section is truly illegible, write [illegible] in its place
